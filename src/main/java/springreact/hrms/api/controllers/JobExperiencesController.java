...
public class JobExperiencesController {
	...
	public ResponseEntity<?> getAllJobExperiencesByResumeId(@PathVariable("id") int resumeId) {
	...
	public ResponseEntity<?> getAllJobExperiencesByResumeIdOrderByEndDateDesc(@PathVariable("id") int resumeId) {
